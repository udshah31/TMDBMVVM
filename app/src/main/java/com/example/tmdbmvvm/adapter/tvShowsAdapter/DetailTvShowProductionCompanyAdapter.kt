...
import com.example.tmdbmvvm.models.tvshowdetail.ProductionCompany
import com.example.tmdbmvvm.util.Constants.Companion.IMAGE_URL_FRONT
import javax.inject.Inject

class DetailTvShowProductionCompanyAdapter @Inject constructor(
    private val glide: RequestManager
) :
    RecyclerView.Adapter<DetailTvShowProductionCompanyAdapter.ViewHolder>() {
