...
import com.example.tmdbmvvm.models.moviedetail.ProductionCountry
import javax.inject.Inject

class DetailMovieProductionCountriesAdapter @Inject constructor() :
    RecyclerView.Adapter<DetailMovieProductionCountriesAdapter.ViewHolder>() {
