...
@AndroidEntryPoint
class DetailTvAiringTodayFragment : Fragment(R.layout.tv_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tvAiringToday = arguments?.getParcelable<Result>("tvAiringToday")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + tvAiringToday?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + tvAiringToday?.poster_path
            ...
            tvName.text = tvAiringToday?.original_name
        ...
        viewModel.getTvImages(tvAiringToday!!.id)
        viewModel.getTvShowDetail(tvAiringToday.id)
