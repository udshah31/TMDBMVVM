...
@AndroidEntryPoint
class DetailUpcomingFragment : Fragment(R.layout.movie_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val upcoming = arguments?.getParcelable<Result>("upcoming")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + upcoming?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + upcoming?.poster_path
            ...
            tvName.text = upcoming?.original_title
        ...
        viewModel.getImages(upcoming!!.id)
        viewModel.getMovieDetails(upcoming.id)
