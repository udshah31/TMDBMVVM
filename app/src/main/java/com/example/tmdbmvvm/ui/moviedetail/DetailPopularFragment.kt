...
import com.example.tmdbmvvm.models.movie.popular.Result
...
@AndroidEntryPoint
class DetailPopularFragment : Fragment(R.layout.movie_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val popular = arguments?.getParcelable<Result>("popular")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + popular?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + popular?.poster_path
            ...
            tvName.text = popular?.original_title
        ...
        viewModel.getImages(popular!!.id)
        viewModel.getMovieDetails(popular.id)
