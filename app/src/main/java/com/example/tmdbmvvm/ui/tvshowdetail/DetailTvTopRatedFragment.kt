...
@AndroidEntryPoint
class DetailTvTopRatedFragment : Fragment(R.layout.tv_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tvTopRated = arguments?.getParcelable<Result>("tvTopRated")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + tvTopRated?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + tvTopRated?.poster_path
            ...
            tvName.text = tvTopRated?.original_name
        ...
        viewModel.getTvImages(tvTopRated!!.id)
        viewModel.getTvShowDetail(tvTopRated.id)
