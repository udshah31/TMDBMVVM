...
@AndroidEntryPoint
class DetailTvPopularFragment : Fragment(R.layout.tv_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val tvPopular = arguments?.getParcelable<Result>("tvPopular")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + tvPopular?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + tvPopular?.poster_path
            ...
            tvName.text = tvPopular?.original_name
        ...
        viewModel.getTvImages(tvPopular!!.id)
        viewModel.getTvShowDetail(tvPopular.id)
