...
@AndroidEntryPoint
class DetailTopRatedFragment : Fragment(R.layout.movie_detail_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val topRated = arguments?.getParcelable<Result>("topRated")
        ...
        binding.apply {
            ...
            val backPoster = IMAGE_URL_FRONT + topRated?.backdrop_path
            glide.load(backPoster).into(backgroundPoster)

            val frontPoster = IMAGE_URL_FRONT + topRated?.poster_path
        ...
        viewModel.getImages(topRated!!.id)
        viewModel.getMovieDetails(topRated.id)
